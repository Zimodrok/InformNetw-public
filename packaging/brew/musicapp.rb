class Musicapp < Formula
  ...
  url "https://github.com/Zimodrok/InformNetw.git", tag: "v0.1.18", revision: "851a9a54b9ad02dfea53e6de665ddcc8cb7cbd83"
  ...
  def post_install
    ...
    # Prefer user config dir; fall back to etc if we cannot write to HOME (e.g. locked down brew services)
    ...
    unless psql.exist?
      opoo "psql not found (is PostgreSQL installed?). Skipping DB setup."
      return
    end
    ...
    if has_old
      ...
      schema = opt_pkgshare/"sql/schema.sql"
